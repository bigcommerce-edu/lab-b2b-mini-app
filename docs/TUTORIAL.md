...
Use the `start` Git tag to walk through the code exercises step by step.
...
[Full Lab 3 diff](https://github.com/bigcommerce-edu/lab-b2b-mini-app/compare/prev-order-pre...prev-order-post?diff=split)
